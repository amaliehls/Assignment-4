...
setwd("~/Desktop/R Saves Semester 3/Assignment 4/Plots")

#resp = ggplot(conv,aes(time,Resp1))+geom_line()+geom_line(aes(time,Resp2),color="blue")+labs(title="respconv")

#hr = ggplot(conv,aes(time,HR1))+geom_line()+geom_line(aes(time,HR2),color="blue")+labs(title="hrconv")


#jpeg(file="~/Desktop/R Saves Semester 3/Assignment 4/Plots/myplot.jpeg")
#plot(ggplot(conv,aes(time,Resp1))+geom_line()+geom_line(aes(time,Resp2),color="blue")+labs(title="respconv"))
...
```{r}
#Use the few that worked to find optimal parameters, + in radius is an attempt to reach an RR of about 4%
...
hrturn1 = ggplot(sync1,aes(time,HR1))+geom_line()+geom_line(aes(time,HR2),color="blue")+labs(title="hrturn1")
